...
class Day9Star1 {
    ...
    fun solve() {
        ...
        println("[Day9Star1] Sum of extrapolated values: $sumOfExtrapolatedValues")
        check(sumOfExtrapolatedValues == 1681758908L)
    }

    private fun extrapolateNextValue(values: List<Long>): Long {
        val extrapolatedNumbers = mutableListOf<Long>()
        extrapolatedNumbers.add(values.last())
        ...
        while (true) {
            ...
            currentSequence = n
            extrapolatedNumbers.add(n.last())
